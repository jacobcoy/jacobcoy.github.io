...
$(document).ready(function() {
    ...
    */
    $('#control').click(function() {
        var x;
        if(this.innerHTML == "Spin the Wheel!") {
            a.start();
            b.start();
            c.start();
            this.innerHTML = "Find out my meal";
        ...
        } else if(this.innerHTML == "Find out my meal") {
            a.stop();
            b.stop();
            c.stop();
